...
function mapPropertyData(record) {
    ...
    const restrictions = {
        ...
        allowEviction: fields['AllowEviction'] || false
    };
    const propertyData = {
        ...
        applicationFee: parseFloat(fields['ApplicationFee']) || null,
        leaseProcessingFee: parseFloat(fields['LeaseProcessingFee']) || null,
